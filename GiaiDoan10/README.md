...
### Giai đoạn 8: Hoàn thiện CRUD Thuốc/Dịch vụ

**Tổng quan & Mô tả:** Hoàn thiện code-behind CRUD cho `FrmQuanLyThuoc`, `FrmDichVu`, validate, tìm kiếm, xử lý lỗi toàn vẹn dữ liệu.
**Tính năng chính:** Thêm/sửa/xóa/tìm kiếm thuốc, dịch vụ, validate đầu vào, chặn xóa khi có phát sinh nghiệp vụ, định dạng mã hiển thị, đơn giá.
**Khó khăn & Kinh nghiệm:** Cần unique constraint ở DB, cân nhắc trạng thái active/inactive thay vì xóa vật lý, checklist CRUD chuẩn, xử lý ngoại lệ FK, hardening code sau mỗi mốc lớn.

---

### Giai đoạn 9: Hoàn thiện thanh toán & mã hiển thị phiếu khám

**Tổng quan & Mô tả:** Triển khai logic thực cho `FrmThuNgan`, bổ sung mã hiển thị phiếu khám, đồng bộ migration, nâng mức liên thông điều hướng.
**Tính năng chính:** Nạp phiếu khám chưa thanh toán, tìm kiếm, tính tổng tiền, xác nhận thanh toán, bổ sung mã hiển thị (`MaHienThi`), điều hướng đồng bộ menu/toolstrip.
**Khó khăn & Kinh nghiệm:** Chuỗi kết nối hard-code, migration rỗng dễ gây hiểu nhầm trạng thái DB, checklist chuẩn hóa mã hiển thị, giảm warning nullability, bảo vệ credential.
