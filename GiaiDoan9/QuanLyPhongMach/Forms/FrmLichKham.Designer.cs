namespace QuanLyPhongMach.Forms
{
    partial class FrmLichKham
    {
        ...
        private void InitializeComponent()
        {
            ...
            dtbNgayKham.MinDate = new DateTime(2026, 3, 29, 19, 9, 50, 0);
            dtbNgayKham.Name = "dtbNgayKham";
            dtbNgayKham.Size = new Size(404, 31);
            dtbNgayKham.TabIndex = 7;
            dtbNgayKham.Value = new DateTime(2026, 3, 29, 19, 9, 50, 0);
            dtbNgayKham.ValueChanged += dtbNgayKham_ValueChanged;
            // 
            // label7
            // 
